                ...
                <div class="inner-container">
                    ...
                    <div class="c-box">
                        <div class="logo-inner">
                            <div class="logo"><a href="index.html"><img src="images/logo.png" alt="" title="Boxcar"></a>
                            </div>
                            <div class="layout-search">
                                <div class="search-box">
                                    ...
                                    <input type="search" placeholder="Search Cars eg. Audi Q7" class="show-search"
                                ...
                                <div class="box-content-search" id="box-content-search">
                                    <ul class="box-car-search">
                                        <li><a href="inventory-page-single.html" class="car-search-item">
                                                ...
                                                <div class="info">
                                                    <p class="name">Audi, Q5 - 2023 C300e AMG Line Night Ed Premium Plus
                                                        5dr 9G-Tronic</p>
